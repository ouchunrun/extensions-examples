...
function createCopyButton(e, pasteText){
    ...
    copyButton.style = 'position: absolute;background-color: #fff;box-shadow: #919191 0px 0px 10px;border: none;border-radius: 2px;width: 50px;height: 30px;font-size: 14px;'
